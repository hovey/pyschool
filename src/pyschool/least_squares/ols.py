...
def main(argv):
    ...
    input_table = np.genfromtxt('input.csv', dtype='float', delimiter=',', skip_header=n_header_rows)
    ...
    if m == n:
        ...
        print('Error: Problem is under-constained, rank is not sufficient for solution.')
        return  # early return because folder does not exist
